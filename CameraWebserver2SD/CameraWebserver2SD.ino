...
static esp_err_t SavePicToSD_handler(){
    camera_fb_t * fb = NULL;
    esp_err_t res = ESP_OK;
    int64_t fr_start = esp_timer_get_time();
    fb = esp_camera_fb_get(); //get picture from cam 
...
sprintf(filename,"/%02d%02d%02d-%02d%02d%02d.jpg",timeinfo.tm_year-100,timeinfo.tm_mon,timeinfo.tm_mday,timeinfo.tm_hour,timeinfo.tm_min,timeinfo.tm_sec);
fs::FS &fs = SD_MMC; 
    Serial.printf("Writing file: %s\n", filename);
